...
namespace RT334015_MIS4200.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "appointmentId,description,apptDate,patientId,doctorId")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "appointmentId,description,apptDate,patientId,doctorId")] Appointment appointment)
        {
            if (ModelState.IsValid)
            {
